...
vmaxg=23.51;% maximum glucose specific consumption rate (mmol/gDCW/h)
Kmg=22.5;% saturation constant (mmol/L)
Sg=zeros(11,1);
Sg(1)=110.739;% initial glucose concentration for the first step (mmol/L)
Slg=zeros(11,1);
...
for j=1:11
    ...
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0068',0.0488*v1(j),'b');%acetate0.05470.0485
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0069',0.0047*v1(j),'b');%citrate
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0070',0.0026*v1(j),'b');%pyruvate
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0027',0.0167*v1(j),'b');%acetoin
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0002',1.8798*v1(j),'b');%lactate1.8741.879
    % AA
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0014',0.0147*v1(j),'b');%ala
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0015',-0.1,'l');%arg
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0016',-0.1,'l');%cys
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0017',-0.0293*v1(j),'l');%glu
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0018',-0.0003*v1(j),'l');%his
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0019',-0.0193*v1(j),'l');%ile
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0020',-0.0107*v1(j),'l');%leu
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0021',-0.0046*v1(j),'l');%met
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0022',-0.0450*v1(j),'l');%thr
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0023',-0.0096*v1(j),'l');%val
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0024',-0.0065*v1(j),'l');%tyr
...
for j=1:11
    ...
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0003',0.01*v1(j),'b');%CO2
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0004',-0.0044*v1(j),'b');%O2
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0068',0.0488*v1(j),'b');%acetate
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0069',0.0047*v1(j),'b');%citrate
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0070',0.0026*v1(j),'b');%pyruvate
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0027',0.0167*v1(j),'b');%acetoin
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0002',1.8798*v1(j),'b');
    % AA
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0014',0.0147*v1(j),'b');%ala
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0015',-0.1,'l');%arg
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0016',-0.1,'l');%cys
...
%% MORP
model_tre(1) = ecModel;
vmaxt=0.602;% maximum trehalose specific consumption rate (mmol/gDCW/h)
Kmt=10;% saturation constant (mmol/L)
St=zeros(69,1);
St(1)=58.81;% trehalose concentration (mmol/L)
Slt=zeros(69,1);
Slt(1)=0;% lactate concentration (mmol/L)
dcwt=zeros(69,1);
dcwt(1)=1.98;% biomass (g/L)
v2=zeros(69,1);
...
model_tre(1) = changeRxnBounds(model_tre(1),'EX0014',0.06*v2(1),'l');%ala
model_tre(1) = changeRxnBounds(model_tre(1),'EX0015',-0.1,'l');%arg
model_tre(1) = changeRxnBounds(model_tre(1),'EX0016',-0.1,'l');%cys
model_tre(1) = changeRxnBounds(model_tre(1),'EX0017',-0.0027*v2(1),'l');%glu
model_tre(1) = changeRxnBounds(model_tre(1),'EX0018',-0.0034*v2(1),'l');%his
model_tre(1) = changeRxnBounds(model_tre(1),'EX0019',-0.0106*v2(1),'l');%ile
model_tre(1) = changeRxnBounds(model_tre(1),'EX0020',-0.0060*v2(1),'l');%leu
model_tre(1) = changeRxnBounds(model_tre(1),'EX0021',0.0026*v2(1),'l');%met
model_tre(1) = changeRxnBounds(model_tre(1),'EX0022',-0.0333*v2(1),'l');%thr
model_tre(1) = changeRxnBounds(model_tre(1),'EX0023',-0.0102*v2(1),'l');%val
model_tre(1) = changeRxnBounds(model_tre(1),'EX0024',-0.0057*v2(1),'l');%tyr
...
for i=1:68
    ...
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0014',0.06*v2(i+1),'l');%ala
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0015',-0.1,'l');%arg
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0016',-0.1,'l');%cys
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0017',-0.0027*v2(i+1),'l');%glu
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0018',-0.0034*v2(i+1),'l');%his
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0019',-0.0106*v2(i+1),'l');%ile
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0020',-0.0060*v2(i+1),'l');%leu
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0021',0.0026*v2(i+1),'l');%met
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0022',-0.0333*v2(i+1),'l');%thr
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0023',-0.0102*v2(i+1),'l');%val
    model_tre(i+1) = changeRxnBounds(model_tre(i+1),'EX0024',-0.0057*v2(i+1),'l');%tyr
