...
for j=1:11
    ...
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0068',0.0547*v1(j),'b');%acetate
    ...
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0002',1.874*v1(j),'b');%lactate
    % AA
...
for j=1:11
    ...
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0070',0.0026*v1(j),'b');%pyruvate
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0027',0.0167*v1(j),'b');%acetoin
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0002',1.874*v1(j),'b');
    % AA
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0014',0.0147*v1(j),'b');%ala
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0015',-0.1,'l');%arg
    model_glu(j) = changeRxnBounds(model_glu(j),'EX0016',-0.1,'l');%cys
...
%% ecMOMA
model_tre(1) = ecModel;
vmaxt=0.62;%mmol/gDCW/h
Kmt=10;%mmol/L海藻糖米氏常数 
St=zeros(69,1);
St(1)=58.81;%mmol/L海藻糖浓度
Slt=zeros(69,1);
Slt(1)=0;%mmol/L乳酸浓度
dcwt=zeros(69,1);
dcwt(1)=1.98;%g/L菌体干重 
